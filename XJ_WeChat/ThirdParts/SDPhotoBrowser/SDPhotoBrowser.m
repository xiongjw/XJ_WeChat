...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    if ([self.sourceImagesContainerView isKindOfClass:UIImageView.class]) {
...
- (void)showFirstImage
{
    ...
    if ([self.sourceImagesContainerView isKindOfClass:UIImageView.class]) {
        rect = [self.sourceImagesContainerView.superview convertRect:sourceView.frame toView:self];
    }
