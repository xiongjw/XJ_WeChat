...
- (instancetype)initWithCustomView:(UIView *)customView eventHandler:(void(^)(void))eventHandler {
...
+ (instancetype)blockedBarButtonItemWithTitle:(NSString *)title eventHandler:(void (^)(void))eventHandler {
...
+ (instancetype)blockedBarButtonItemWithImage:(UIImage *)image eventHandler:(void (^)(void))eventHandler {
...
+ (instancetype)blockedBarButtonItemWithBarButtonSystemItem:(UIBarButtonSystemItem)systemItem eventHandler:(void (^)(void))eventHandler {
...
+ (instancetype)blockedBarButtonItemWithCustomView:(UIView *)customView eventHandler:(void (^)(void))eventHandler {
